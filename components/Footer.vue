<template>
  <v-footer dark class="let-foot">
    ...
    <v-divider></v-divider>
    <v-container class="footer-copy">
      <div class="footer-bottom">
        <v-row>
          <v-col cols="12" sm="6">
            <div class="copyy">
              Copyright &copy; {{ new Date().getFullYear() }} Letme-save.com.
              All rights reserved.
            </div>
          </v-col>
          <v-col cols="12" sm="6">
...
export default {
  ...
  mounted() {
    // if (process.browser) {
    //   let localuserData = cookies.get("userData");
    //   if (localuserData) {
...
.footer-top .theme--dark.v-list {
  background: unset;
}
.footer-top .v-list-item {
  min-height: unset;
  font-size: 14px;
}
.footer-top .v-subheader {
  font-size: 15px;
  color: #fff;
  font-weight: 500;
  height: 40px;
