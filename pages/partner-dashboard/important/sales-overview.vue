        ...
        <v-container>
            <div class="order-list">
                ...
                <v-row>
                    ...
                    cols="12"
                    >
                        <h4 class="head-date">{{item.date}}</h4>
                        <div class="order-item">
                            <div class="order-item-left">
                                <div class="order-name">
                                    <p class="date-id">{{item.id}}</p>
                                </div>
                            ...
                            <div class="order-item-right">
                                <div class="order-amount">
                                    <p>Total amount <span>{{item.total_amount}} NOK</span></p>
                                    
                                </div>
                                <div class="order-amount">
                                    <p>Paid online <span>{{item.paid_online}} NOK</span></p>
                                </div>
                                <div class="order-amount">
                                    <p>Paid at store <span>{{item.paid_at_hotel}} NOK</span></p>
                                </div>
                            </div>
                        </div>
                    </v-col>
