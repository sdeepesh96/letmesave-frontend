        ...
        <v-container>
            <div class="review-sec">
                <div class="review-top-sec">
                    <h3>Guest Reviews</h3>
                    <p>See what your customer is saying about their experience! Read and reply to your customer's review.</p>
                    <h5>Reply should  be genuine, unique, respect to the pravacy and appropiate to the internation customers.
                        <span>Below reviews are opinions from rour customers and not Letme-save.com's. Letme-Save.com is not 
                            liable and responsible for any reviews or responses.</span>
                    </h5>
                        ...
                        <div class="review-rating bottom" >
                            ...
                            <div class="right-sec">
                                <div class="orderid-sec">
                                    <p>Justin</p>
                                    <p>Order Id - {{item.orderid}} <span>{{item.date}}</span></p>
                                </div>
                                <div class="rating-sec">
                                    <div>
                                        <v-rating
      ...
      items:[
        {
          ...
          location: 5,
          price: 5,
          review: 'Really it was the best a low price...'
        },
        {
          orderid: '0987654',
          date: 'May 30,2020',
...
@media (max-width:1023px){
    ...
    .rating-footer {
        grid-template-columns: .98fr max-content;
    }
}
